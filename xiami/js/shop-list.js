var shopList=new Vue({
    ...
    components:{
        sgList:{
            data:function () {
                return {
                    shanList: [
                        ...
                        {path: "image/shangou/shangou-image-6.vue.jpg",name:"电力猫套装",content:"有插座的地方&nbsp就有WIFI",newprice:"185元&nbsp",oldprice:"249元",biaoqian:"",style:{backgroundColor:"#ffffff"}},
            ...
            template:"<div class='shangou-box' v-cloak><ul id='shangou-list'><li v-for='item in shanList' class='shop-li'><img :data-original='item.path' class='small-img lazy'/><p v-html='item.name' class='shangou-name'></p><p v-html='item.content' class='shangou-content'></p><p class='shangou-price'><span v-html='item.newprice'></span><span v-html='item.oldprice'></span></p><p class='shangou-biaoqian' :style='item.style' v-html='item.biaoqian'></p></li><div class='clear'></div></ul></div>"
        }
    }
})