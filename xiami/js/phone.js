var phoneList=new Vue({
    ...
    components: {
        iphoneList: {
            data: function () {
                return {
                    shanList: [
                        ...
                        {
                            path: "image/phone/phone-list-6.vue.jpg",
            ...
            template: "<div class='phone-list-box'><ul id='phone-alllist'><li v-for='item in shanList' class='main-li'><img :data-original='item.path' class='small-img lazy'/><p v-html='item.name' class='shangou-name'></p><p v-html='item.content' class='shangou-content'></p><p class='shangou-price'><span v-html='item.newprice'></span><span v-html='item.oldprice'></span></p><p class='shangou-biaoqian' :style='item.style' v-html='item.biaoqian'></p></li><div class='clear'></div></ul></div>"
        }
    }
})