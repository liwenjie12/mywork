...
Vue.component("allList",{
    ...
    template: "<div class='all-list-box' @chuan='change'><ul id='shop-alllist'><li v-for='item in shanList' class='main-li'><img :src='item.path' class='small-img lazy'/><p v-html='item.name' class='shangou-name'></p><p v-html='item.content' class='shangou-content'></p><p class='shangou-price'><span v-html='item.newprice'></span><span v-html='item.oldprice'></span></p><p class='shangou-biaoqian' :style='item.style' v-html='item.biaoqian'></p></li><show-more :small='xiList'></show-more><div class='clear'></div></ul></div>"
});
Vue.component("listImg",{
    ...
    template:"<div :style='divStyle'><img v-for='item in two.twoImg' :src='item' :style='imgStyle'/></div>",
});
